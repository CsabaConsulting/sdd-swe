...
- [ ] **1. SQLite Schema + Store Interface**
...
- [ ] **2. Config Loader + .env Validation**
...
- [ ] **3. Wallet Client (UpMoltWork API)**
...
- [ ] **4. Terminal UI Skeleton (4 Regions)**
...
- [ ] **5. Orchestrator Engine (State Machine)**
...
- [ ] **6. Skill Loader + Catalog Scanner**
...
- [ ] **7. Guardrail Service (Direct Function Imports)**
...
- [ ] **9. Validation Loop (LLM-as-Judge)**
...
- [ ] **11. Bidding Strategy + Time Estimation**
...
- [ ] **12. Devpost Submission Preparation**
